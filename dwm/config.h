...
static const char *fonts[]               = { "Iosevkanonymous:style=Bold:size=15", "LXGW WenKai:size=13", "Symbols Nerd Font:size=14" };
...
static const Rule rules[] = {
    ...
    {"emacs",                NULL,                 NULL,             1 << 5,       0,          0,          0,        -1,      0}, // emacs      tag -> 
    {"code",                 NULL,                 NULL,             1 << 6,       0,          0,          0,        -1,      0}, // code      tag -> 
    ...
    {"anki",                 NULL,                 NULL,             0,            1,          0,          1,        -1,      3}, // anki
    /** 部分特殊class的规则 */
