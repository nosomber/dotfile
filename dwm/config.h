...
static int gappi                         = 1;        /* 窗口与窗口 缝隙大小 */
static int gappo                         = 1;        /* 窗口与边缘 缝隙大小 */
static const int _gappo                  = 1;        /* 窗口与窗口 缝隙大小 不可变 用于恢复时的默认值 */
...
static const char *fonts[]               = { "Iosevkanonymous:style=Bold:size=12", "LXGW WenKai:size=11", "Symbols Nerd Font:size=12" };
static const char *colors[][3]           = {          /* 颜色设置 ColFg, ColBg, ColBorder */ 
    [SchemeNorm] = { "#bbbbbb", "#000000", "#444444" },
    [SchemeSel] = { "#ffffff", "#37474F", "#42A5F5" },
    [SchemeSelGlobal] = { "#ffffff", "#000000", "#FFC0CB" },
...
static const char *tags[] = { 
    "", // tag:0  key:1  desc:terminal0
    "󰎤", // tag:1  key:2  desc:terminal1
    "󰎧", // tag:2  key:3  desc:terminal2
    "󰎪", // tag:3  key:4  desc:terminal3
    "", // tag:4  key:w  desc:chrome
    "", // tag:5  key:e  desc:emacs
    "󰅬", // tag:6  key:r  desc:code
    "󰎶", // tag:7
    "", // tag:8  key:c  desc:wechat 
    "󰎼", // tag:9
};
...
static const Rule rules[] = {
    ...
    /** 优先级高 越在上面优先度越高 */
    /** 普通优先度 */
    {"chrome",               NULL,                 NULL,             1 << 4,       0,          0,          0,        -1,      0}, // chrome 
    {"emacs",                NULL,                 NULL,             1 << 5,       0,          0,          0,        -1,      0}, // emacs 
    {"Visual Studio Code",   NULL,                 NULL,             1 << 6,       0,          0,          0,        -1,      0}, // code  
    {"WeChat Beta",          NULL,                 NULL,             1 << 8,       0,          0,          0,        -1,      0}, // wechat 
    { NULL,                  NULL,                 "Drawing",        0,            1,          0,          0,        -1,      0}, // Drawing     
    { NULL,                  NULL,                 "feh",        0,            1,          0,          0,        -1,      0}, // Drawing     
    ...
    {"xournalpp",            NULL,                 NULL,             0,            1,          0,          1,        -1,      3}, // xournalpp 
    {"anki",                 NULL,                 "Add",            0,            1,          1,          0,        -1,      0}, // anki
    /** 部分特殊class的规则 */
...
static Key keys[] = {
    ...
    // { MODKEY|ShiftMask,    XK_a,      spawn, SHCMD("scrot -s '\\%y-\\%m-\\%d-\\%H-\\%M-\\%s.png' -e 'mv $f ~/room/photo/screen/'") }, /* super shift a | 截图     */
    { MODKEY|ShiftMask,    XK_a,      spawn, SHCMD("flameshot gui -r | tee ~/room/photo/screen/$(date '+%y-%m-%d-%H-%M-%S').png | xclip -selection clipboard -t image/png") },
    ...
    TAGKEYS(XK_3, 2, 0)
    TAGKEYS(XK_4, 3, 0)
    TAGKEYS(XK_w, 4, "google-chrome-stable")
    TAGKEYS(XK_e, 5, "emacs")
    TAGKEYS(XK_r, 6, "code")
    TAGKEYS(XK_7, 7, 0)
    TAGKEYS(XK_c, 8, "wechat-universal")
    TAGKEYS(XK_9, 9, 0)
};
