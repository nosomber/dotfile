...
static char *font = "Iosevkanonymous:pixelsize=21:antialias=true:autohint=true";
//static char *font = "weibq:pixelsize=21:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
	...
	{ ZOOMODKEY,            XK_equal,       zoom,           {.f = +1} },
	{ ZOOMODKEY,            XK_minus,       zoom,           {.f = -1} },
